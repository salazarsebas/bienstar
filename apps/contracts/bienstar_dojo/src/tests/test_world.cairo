...
mod tests {
    ...
    use bienstar_dojo::models::{Direction, Moves, Position, m_Moves, m_Position};
    use bienstar_dojo::systems::actions::{IActionsDispatcher, IActionsDispatcherTrait, actions};
    use starknet::ContractAddress;

    fn namespace_def() -> NamespaceDef {
        let ndef = NamespaceDef {
            namespace: "bienstar_dojo",
            resources: [
    ...
    fn contract_defs() -> Span<ContractDef> {
        [
            ContractDefTrait::new(@"bienstar_dojo", @"actions")
                .with_writer_of([dojo::utils::bytearray_hash(@"bienstar_dojo")].span())
        ]
            .span()
    }
